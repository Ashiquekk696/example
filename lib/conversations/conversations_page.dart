...
//   ConversationsPage({required this.conversationsNotifier});
...
//   Widget _buildBody() {
//     print("widget.conversationsNotifier.conversations[0].friendlyName");
//     print(widget.conversationsNotifier.conversations[0].friendlyName);
//     print("widget.conversationsNotifier.conversations[0].friendlyName");
//     return Container(
//       height: 333,
...
//                 widget.conversationsNotifier.getMyConversations();
//               }),
//           // randomChat(widget.conversationsNotifier.conversations[0]),
...
//         itemBuilder: (_, index) {
//           print(widget.conversationsNotifier.conversations.length);
...
//                           await widget.conversationsNotifier.join();
//                         } else {
